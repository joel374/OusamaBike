  ...
  return (
    <Box m="85px auto" w="1200px">
          ...
          <Box display={"flex"} flexDirection="column" s w="350px" pr="100px">
            ...
            <Box>
              ...
              >
                ...
                <br />
                <br />
                Disarankan untuk <b>tidak memasukkan</b> info nomor HP, e-mail,
                dsb. ke dalam deskripsi produk untuk melindungi data pribadimu.
              </Text>
            </Box>
          </Box>
          <Box w="605px">
      ...
      >
        ...
        <Button h="38px" w="156px" fontSize={"12px"}>
          Simpan
        </Button>
      </Box>
    </Box>
