...
const Navbar = () => {
  ...
  return (
    ...
    <Grid templateColumns={"repeat(3,1fr)"} h='125px'
      bgColor={'#222222'}
      fontFamily={'Barlow'}
      fontStyle={'italic'}
      w='100%'
    ...
    >
      <GridItem display={'flex'} justifyContent={'center'} alignItems={'center'}>
        <Image src={logo} h='120px' onClick={() => navigate('/')} />
      </GridItem>
      {isSearch ?
        ...
        <GridItem display={'flex'} justifyContent={'center'} alignItems={'center'} gap='4'>
          <Input height={'55px'} bgColor={'#B7B7B7'} borderRadius={'50px'} placeholder='Search in King Bike' border={'0px'} />
        </GridItem>
      }
      <GridItem display={'flex'} justifyContent={'center'} alignItems={'center'} gap='4'>
        <Box w='55px' h='55px' onClick={() => setIsSearch(isSearch ? false : true)} cursor='pointer' bgColor={'#B7B7B7'} borderRadius={'50%'} display={'flex'} justifyContent={'center'} alignItems={'center'}>
        ...
        <Box w='55px' h='55px' cursor='pointer' bgColor={'#D9D9D9'} borderRadius={'50%'} display={'flex'} justifyContent={'center'} alignItems={'center'}>
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
