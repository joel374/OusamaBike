  ...
  return (
    ...
    >
      ...
      {isSearch ?
        ...
        <GridItem display={'flex'} justifyContent={'center'} alignItems={'center'} gap='4'>
          <Input height={'45px'} bgColor={'#B7B7B7'} borderRadius={'50px'} placeholder='Search in King Bike' border={'0px'} />
        </GridItem>
      }
      <GridItem display={'flex'} justifyContent={'center'} alignItems={'center'} gap='4'>
        <Box w='45px' h='45px' onClick={() => setIsSearch(isSearch ? false : true)} cursor='pointer' bgColor={'#B7B7B7'} borderRadius={'50%'} display={'flex'} justifyContent={'center'} alignItems={'center'}>
